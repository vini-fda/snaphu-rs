...
/// Wall-clock timer snapshot captured at program start.
///
...
/// Elapsed wall-clock timing derived from a [`TimerSnapshot`].
///
...
mod tests {
    ...
    fn start_and_display_timers_return_non_negative_elapsed_time() {
        ...
        assert!(elapsed.wall_seconds >= 0.02);
    }
